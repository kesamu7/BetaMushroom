...
namespace BetaMushroom.Data.Migrations
{
    ...
    [Migration("20170621165151_addShroomPropsToAppUser")]
    partial class addShroomPropsToAppUser
    {
            ...
            modelBuilder.Entity("BetaMushroom.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasOne("BetaMushroom.Models.MushroomActivity", "mushActivity")
                        .WithMany()
                        .HasForeignKey("mushActivityID");
